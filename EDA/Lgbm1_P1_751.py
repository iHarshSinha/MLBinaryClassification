...
# --- Import preprocessed data & target from P1 ---
...
submission.to_csv("lgbm_f1_hard_labels_submission_final.csv", index=False)
print("\nSaved submission as 'lgbm_f1_hard_labels_submission_final.csv'")
